                ...
                <div className="analysis-models-main-flow space-y-4">
                  ...
                  <section className="analysis-flow-section analysis-flow-section--ranking rounded-[24px] border border-white/8 bg-white/[0.03] p-4">
                    ...
                    <div className="mt-4 space-y-3">
                      ...
                      }) : <div className="rounded-[20px] border border-white/8 bg-black/20 px-4 py-5 text-sm leading-6 text-white/56">{insightError ?? (loadingInsight ? UI_TEXT.analysis.rankingLoading : analysisUnavailable ? UI_TEXT.analysis.waitingModelData : NO_FILTER_MATCH_TEXT)}</div>}
                    </div>
