  ...
  const getKellyWorkbench = vi.fn().mockImplementation(
    async (
      ...
      weatherEvidence: {
        ...
        observationFloorTemperatureC: options?.actualTemperatureC ?? 24.5,
        observationFloorSource: "manual" as const,
        observationFloorObservedAt: options?.selectedHourTimestamp ?? "2026-03-28T03:00:00+08:00",
